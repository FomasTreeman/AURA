...
app = FastAPI(title="AURA Observability Service")

REQUEST_COUNTER = Counter("aura_requests_total", "Total requests to the observability service")
...
async def sse_stream():
    ...
    async def event_generator():
        for i in range(5):
            yield f"data: observability event {i}\n\n"
